...
const SKILLS = [
  ...
  { img: "./images/flutter.png", name: "Flutter" },
  { img: "./images/typscript.png", name: "TypeScript" },
  { img: "./images/javascript.svg", name: "JavaScript" },
  { img: "./images/react.svg", name: "React" },
  { img: "./images/css.svg", name: "Tailwind CSS" },
  { img: "./images/nodejs.png", name: "Node.js" },
  { img: "./images/google-firebase-icon.svg", name: "Firebase" },
  { img: "./images/mongoDb.png", name: "MongoDB" },
  { img: "./images/machine-learning.svg", name: "Machine Learning with Python" },
